...
public interface UserMypageMapper {
	...
	public int usermypage_activity_gettotal(@Param("user_id") String user_id, 
											@Param("cri") Criteria cri); //사용자 활동 리스트 총합 구하기
	public ArrayList<TB_012VO> usermypage_activity_getlist(@Param("user_id") String user_id, 
	...
	public int usermypage_pausetotal (@Param("user_proper_num") int user_proper_num, 
									  @Param("cri") Criteria cri); //사용자 중지 리스트 총합구하기
	public ArrayList<TB_014VO> usermypage_pauselist(@Param("user_proper_num") int user_proper_num, 
