...
public interface UserMypageService {
	...
	public ArrayList<TB_005VO> usermypage_application_getlist(String user_id, Criteria cri); //사용자 신청 리스트 목록 구하기
	...
	public int usermypage_activity_gettotal(String user_id, Criteria cri); //사용자 활동 리스트 총합 구하기
	public ArrayList<TB_012VO> usermypage_activity_getlist(String user_id, Criteria cri); //사용자 활동 리스트 목록구하기
	...
	public int usermypage_pausetotal (int user_proper_num, Criteria cri); //사용자 중지 리스트 총합구하기
	public ArrayList<TB_014VO> usermypage_pauselist(int user_proper_num, Criteria cri); //사용자 중지 리스트 가져오기
